...
public class Cliente {
    ...
    //Constructor para busqueda o eliminacion de registros
    public Cliente(int idCliente) {
        this.idCliente = idCliente;
    }

    //Constructor para insertar nuevo registro, id es automatico
    ...
    //Constructor para modificacion de datos, busqueda por id
